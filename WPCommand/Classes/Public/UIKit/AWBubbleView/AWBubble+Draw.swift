...
public extension AWBubble {
    class func pathWith(rect: CGRect, frame: CGRect, direction: AWBubble.Direction, arrowSize: CGSize, arrowPosition: CGPoint, arrowRadius: CGFloat, borderWidth: CGFloat = 0, radius: CGFloat = 0) -> UIBezierPath {
