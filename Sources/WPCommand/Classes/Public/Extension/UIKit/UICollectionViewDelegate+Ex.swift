...
extension WPCollectionViewDelegate: UICollectionViewDelegateFlowLayout {
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        } else if let item = collectionView.wp_source.groups.wp_get(of: indexPath.section)?.items.wp_get(of: indexPath.row) {
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        ...
        } else if let group = collectionView.wp_source.groups.wp_get(of: section) {
