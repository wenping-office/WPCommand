...
extension WPTableViewDelegate: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        let item = tableView.wp_source.groups.wp.get(indexPath.section)?.items.wp.get(indexPath.row)
    ...
    public func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        let group = tableView.wp_source.groups.wp.get(indexPath.section)
        
        if let item = group?.items.wp.get(indexPath.row) {
    ...
    public func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        let group = tableView.wp_source.groups.wp.get(section)
    ...
    public func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        } else if let group = tableView.wp_source.groups.wp.get(section) {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let item = tableView.wp_source.groups.wp.get(indexPath.section)?.items.wp.get(indexPath.row) {
    ...
    public func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
        ...
        if let group = tableView.wp_source.groups.wp.get(section) {
    ...
    public func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let group = dataSource.groups.wp.get(indexPath.section)
        let item = group?.items.wp.get(indexPath.row)
    ...
    public func tableView(_ tableView: UITableView, editingStyleForRowAt indexPath: IndexPath) -> UITableViewCell.EditingStyle {
        let dataSource = tableView.wp.dataSource
        let item = dataSource.groups.wp.get(indexPath.section)?.items.wp.get(indexPath.row)
